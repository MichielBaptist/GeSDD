...
class conjunction_generator(generator):
    pass


class recursive_generator(generator):

    def __init__(self, domain_size, indicator_manager, manager = None, count_manager = None, fn_sparseness = 0.25, operation_distr = [1,10000000,1], min_feature_size = 2, feature_size_factor=1.5, subgroup_size_factor = 1.0, remove_after_select_p = 0.95, negation_prob = 0.5, max_nb_factors = 10):
    ...
    def gen(self):
        ...
        modl.set_count_manager(self.count_manager)
        modl.set_unique_ID(self.next_id())
    ...
    def random_feature_f(self):
        ...
        rand_feature = self.random_composition_base(rand_subselection)
